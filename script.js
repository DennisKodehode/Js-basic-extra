...
if (age >= 18 && (hasTicket || isVIP) && hour >= 18 && hour <= 23) {
...
startValue = ((startValue + 5) * 2 - 4) / 3;
console.log(startValue);

if (startValue % 1 === 0 && startValue < 10) {
  console.log("Liten helt");
} else if (startValue % 1 === 0 && startValue >= 10) {
